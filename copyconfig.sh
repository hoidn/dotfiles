...
files=".bashrc .bash_profile .vimrc .vimrc_common .inputrc .vim .clvv-fasd-4822024 .fzf .config/ranger .config/nvim .spacemacs .emacs.d .profile .omzshrc .shrc .tmux.conf"
